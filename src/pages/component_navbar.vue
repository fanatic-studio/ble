    ...
    <div class="app">
        ...
        <navbar class="navbar">
            ...
            <navbar-item type="title">
                <text class="title">{{lang("导航栏")}}</text>
            </navbar-item>
        ...
        <navbar class="navbarb">
            ...
            <navbar-item type="title">
                <text class="nav-title">{{lang("标题")}}</text>
            </navbar-item>
        ...
        <navbar class="navbarb">
            ...
            <!--左边内容-->
            <navbar-item type="left">
                <text class="nav-title">{{lang("左边内容")}}</text>
            </navbar-item>

            <!--中间内容(标题内容)-->
            <navbar-item type="title">
                <text class="nav-title">{{lang("中间(标题)内容")}}</text>
            </navbar-item>

            <!--右边内容-->
            <navbar-item type="right">
                <text class="nav-title">{{lang("右边内容")}}</text>
            </navbar-item>
