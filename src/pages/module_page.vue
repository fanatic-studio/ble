    ...
    <div class="app">
        ...
        <navbar class="navbar">
            ...
            <navbar-item type="title">
                <text class="title">{{lang("页面功能")}}</text>
            </navbar-item>
        ...
        <div class="content">
            <text class="button" @click="openPage">{{lang("打开一个普通的页面")}}</text>
            <text class="button" @click="openPage2">{{lang("打开一个沉浸式页面")}}</text>
            <text class="button" @click="openPage3">{{lang("打开一个全屏的页面")}}</text>
            <text class="button" @click="openPage4">{{lang("打开一个WEB页面")}}</text>

            <div class="item" @click="isLight = !isLight">
                <text class="item-title">{{lang("状态栏字体颜色")}}</text>
    ...
    export default {
        ...
        created() {
            this.addLanguageData("en", {
                "打开一个普通的页面": "Open a normal page",
                "打开一个沉浸式页面": "Open a immersive page",
                "打开一个全屏的页面": "Open a fullscreen page",
                "打开一个WEB页面": "Open a WEB page",
                "状态栏字体颜色": "Status bar font color",
            });
        },
        mounted() {
