    ...
    <div class="app">
        ...
        <navbar class="navbar">
            ...
            <navbar-item type="title">
                <text class="title">{{lang("图片选择器")}}</text>
            </navbar-item>
            <navbar-item type="right" @click="viewCode('markets/eeui/picture')">
        ...
        <div class="content">
            ...
            <text class="button" @click="openPicture">{{lang("选择照片")}}</text>
            <text v-if="lists.length > 0" class="button2" @click="lists=[]">{{lang("清空选择")}}</text>
    ...
    export default {
        ...
        created() {
            this.addLanguageData("en", {
                "选择照片": "select photos",
                "清空选择": "Clear choice",
                "检测到未安装picture插件，安装详细请登录https://eeui.app/": "No installation of the picture plug-in, please login https://eeui.app/ for installation details",
            });
        },
        methods: {
            viewCode(str) {
            ...
            openPicture() {
                if (typeof picture === 'undefined') {
                    eeui.alert({
                        ...
                        message: this.lang("检测到未安装picture插件，安装详细请登录https://eeui.app/"),
                    });
                    return;
                }
                picture.create({
