    ...
    <div class="app">
        ...
        <navbar class="navbar">
            ...
            <navbar-item type="title">
                <text class="title">{{lang("列表容器")}}</text>
            </navbar-item>
    ...
    export default {
        ...
        created() {
            this.addLanguageData("en", {
                "改变第三项文字": "Change the third text",
                "点击了": "click ",
                "项": " item",
                "加载": "load",
                "数据成功": "successed",
                "刷新数据成功": "Data refresh successful",
            });
        },
        mounted() {
            for (let i = 1; i <= 20; i++) {
            ...
            //
            setTimeout(() => {
                this.lists.splice(2, 1, this.lang("改变第三项文字"))
        ...
        methods: {
            ...
            itemClick(params) {
                eeui.toast(this.lang("点击了") + (params.position + 1) + this.lang("项"));
            },
            pullLoadListener() {
                ...
                setTimeout(() => {
                    ...
                    eeui.toast(this.lang("加载") + (count + 1) + "~" + this.lists.length + this.lang("数据成功"));
                }, 1000);
