    ...
    <div class="app">
        ...
        <navbar class="navbar">
            ...
            <navbar-item type="title">
                <text class="title">{{lang('分页网格容器')}}</text>
            </navbar-item>
        ...
        <grid class="grid" @itemClick="itemClick">
            ...
            <div class="grid-item" v-for="item in gridLists">
                <image class="item-image" resize="cover" :src="'https://eeui.app/assets/grid/' + item + '.jpg'"></image>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            itemClick(data) {
                eeui.toast(this.lang("点击第") + (data.page + 1) + this.lang("页第") + (data.position + 1) + this.lang("个，总序号第") + (data.index + 1) + this.lang("个"));
            },
        }
    };
</script>
